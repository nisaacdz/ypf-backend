...
CREATE TYPE "activities"."project_type" AS ENUM('WELFARE', 'COMMUNITY', 'ADVOCACY', 'OTHER');--> statement-breakpoint
...
CREATE TABLE "core"."constituents" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"public_id" text DEFAULT generate_public_id('YPFC-', 12) NOT NULL,
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "constituents_public_id_unique" UNIQUE("public_id"),
...
--> statement-breakpoint
CREATE TABLE "activities"."event_documents" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"event_id" uuid,
	"document_id" uuid,
	"title" text NOT NULL
...
--> statement-breakpoint
CREATE TABLE "activities"."project_beneficiaries" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"project_id" uuid NOT NULL,
	"beneficiary_id" uuid NOT NULL,
	CONSTRAINT "project_beneficiaries_project_id_beneficiary_id_unique" UNIQUE("project_id","beneficiary_id")
);
--> statement-breakpoint
...
CREATE TABLE "activities"."projects" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"public_id" text DEFAULT generate_public_id('YPFP-', 8) NOT NULL,
	"title" text NOT NULL,
	"abstract" text,
	"type" "activities"."project_type" NOT NULL,
	"category" text,
	"description" text,
	"scheduled_start" timestamp with time zone NOT NULL,
	"scheduled_end" timestamp with time zone NOT NULL,
...
ALTER TABLE "core"."constituents" ADD CONSTRAINT "constituents_national_id_document_id_documents_id_fk" FOREIGN KEY ("national_id_document_id") REFERENCES "core"."documents"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "core"."membership_applications" ADD CONSTRAINT "membership_applications_constituent_id_constituents_id_fk" FOREIGN KEY ("constituent_id") REFERENCES "core"."constituents"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "core"."membership_applications" ADD CONSTRAINT "membership_applications_approved_by_admins_id_fk" FOREIGN KEY ("approved_by") REFERENCES "core"."admins"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "core"."membership_applications" ADD CONSTRAINT "membership_applications_preferred_chapter_id_chapters_id_fk" FOREIGN KEY ("preferred_chapter_id") REFERENCES "core"."chapters"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "core"."membership_applications" ADD CONSTRAINT "membership_applications_preferred_committee_id_committees_id_fk" FOREIGN KEY ("preferred_committee_id") REFERENCES "core"."committees"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "activities"."event_documents" ADD CONSTRAINT "event_documents_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "activities"."events"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "activities"."event_documents" ADD CONSTRAINT "event_documents_document_id_documents_id_fk" FOREIGN KEY ("document_id") REFERENCES "core"."documents"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "activities"."project_beneficiaries" ADD CONSTRAINT "project_beneficiaries_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "activities"."projects"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "activities"."project_beneficiaries" ADD CONSTRAINT "project_beneficiaries_beneficiary_id_constituents_id_fk" FOREIGN KEY ("beneficiary_id") REFERENCES "core"."constituents"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "finance"."expenditures" ADD CONSTRAINT "expenditures_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "activities"."events"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "finance"."expenditures" ADD CONSTRAINT "expenditures_vendor_id_organizations_id_fk" FOREIGN KEY ("vendor_id") REFERENCES "core"."organizations"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "finance"."partnerships" ADD CONSTRAINT "partnerships_contract_document_id_documents_id_fk" FOREIGN KEY ("contract_document_id") REFERENCES "core"."documents"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
