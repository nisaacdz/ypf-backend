...
CREATE TABLE "app"."notifications" (
	...
	CONSTRAINT "notifications_broadcast_id_unique" UNIQUE("broadcast_id")
);
--> statement-breakpoint
...
ALTER TABLE "communications"."announcement_broadcasts" ADD CONSTRAINT "announcement_broadcasts_id_announcements_id_fk" FOREIGN KEY ("id") REFERENCES "communications"."announcements"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
