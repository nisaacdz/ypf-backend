...
export const Registrations = core.table("registrations", {
  id: uuid().defaultRandom().primaryKey(),
  firstName: text("first_name").notNull(),
  lastName: text("last_name").notNull(),
  ...
  passportPhotoId: uuid("passport_photo_id").references(() => Media.id),
  ghanaCardFrontId: uuid("ghana_card_front_id").references(() => Media.id),
  ghanaCardBackId: uuid("ghana_card_back_id").references(() => Media.id),
  ...
  willingToServe: text("willing_to_serve"),
  ...
  generatedMemberId: text("generated_member_id"),
...
export const registrationsRelations = relations(Registrations, ({ one }) => ({
  ...
  passportPhoto: one(Media, {
    fields: [Registrations.passportPhotoId],
    references: [Media.id],
  }),
  ghanaCardFront: one(Media, {
    fields: [Registrations.ghanaCardFrontId],
    references: [Media.id],
  }),
  ghanaCardBack: one(Media, {
    fields: [Registrations.ghanaCardBackId],
    references: [Media.id],
  }),
  approver: one(Admins, {
    fields: [Registrations.approvedBy],
    references: [Admins.id],
  }),
}));
