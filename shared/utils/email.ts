...
/**
 * YPF Africa Theme Colors (from website CSS)
 * --primary: HSL(270 59% 30%) -> #301F6E (brand-purple)
 * --accent: HSL(29 100% 52%) -> #FF8C02 (brand-orange)
 * --foreground: HSL(240 10% 3.9%) -> #09090B (near-black)
 * --background: HSL(0 0% 100%) -> #FFFFFF (white)
 * --muted: HSL(240 4.8% 95.9%) -> #F4F4F5 (light-gray)
 * --muted-foreground: HSL(240 3.8% 46.1%) -> #71717A (medium-gray)
 */
const colors = {
  primary: "#301F6E",
  accent: "#FF8C02",
